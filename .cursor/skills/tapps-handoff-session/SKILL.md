...
mcp_tools:
  ...
  - tapps_session_start
---
<!-- BEGIN: tapps-skill tapps-handoff-session v3.12.86 -->
...
<!-- flagged: 9 heading(s) duplicate the managed block above verbatim (# Session handoff, ## Done, ## Open, ## Next (P0), ## Blockers, ## Changed files, ## Verify, ## Success criterion, ## Cumulative (loop checkpoints — required for shift boundaries)); 100% of this region's lines duplicate the managed block above — review and trim -->
