...
echo "[TappsMCP] Launching MCP server: uv run --directory /home/wtthornton/code/tapps-mcp tapps-platform serve --profile nlt-release-ship" >&2
exec uv run --directory /home/wtthornton/code/tapps-mcp tapps-platform serve --profile nlt-release-ship "$@"
