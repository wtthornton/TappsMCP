...
echo "[TappsMCP] Launching MCP server: /home/wtthornton/.tapps-mcp/current/bin/tapps-platform serve --profile nlt-release-ship" >&2
...
exec /home/wtthornton/.tapps-mcp/current/bin/tapps-platform serve --profile nlt-release-ship "$@"
