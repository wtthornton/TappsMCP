...
echo "[TappsMCP] Launching MCP server: /home/wtthornton/.local/share/uv/tools/tapps-mcp/bin/tapps-mcp serve --profile nlt-setup" >&2
...
exec /home/wtthornton/.local/share/uv/tools/tapps-mcp/bin/tapps-mcp serve --profile nlt-setup "$@"
