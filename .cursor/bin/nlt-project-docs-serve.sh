...
echo "[TappsMCP] Launching MCP server: /home/wtthornton/.tapps-mcp/current/bin/docsmcp serve --profile nlt-project-docs" >&2
...
exec /home/wtthornton/.tapps-mcp/current/bin/docsmcp serve --profile nlt-project-docs "$@"
