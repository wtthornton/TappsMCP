...
echo "[TappsMCP] Launching MCP server: uv run --directory /home/wtthornton/code/tapps-mcp docsmcp serve --profile nlt-project-docs" >&2
exec uv run --directory /home/wtthornton/code/tapps-mcp docsmcp serve --profile nlt-project-docs "$@"
