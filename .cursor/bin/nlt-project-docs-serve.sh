...
echo "[TappsMCP] Launching MCP server: /home/wtthornton/code/tapps-mcp/.venv/bin/docsmcp serve --profile nlt-project-docs" >&2
exec /home/wtthornton/code/tapps-mcp/.venv/bin/docsmcp serve --profile nlt-project-docs "$@"
