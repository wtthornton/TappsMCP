...
echo "[TappsMCP] Launching MCP server: /home/wtthornton/code/tapps-mcp/.venv/bin/tapps-mcp serve --profile nlt-build" >&2
exec /home/wtthornton/code/tapps-mcp/.venv/bin/tapps-mcp serve --profile nlt-build "$@"
