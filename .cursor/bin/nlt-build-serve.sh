...
echo "[TappsMCP] Launching MCP server: /home/wtthornton/.tapps-mcp/current/bin/tapps-mcp serve --profile nlt-build" >&2
...
exec /home/wtthornton/.tapps-mcp/current/bin/tapps-mcp serve --profile nlt-build "$@"
