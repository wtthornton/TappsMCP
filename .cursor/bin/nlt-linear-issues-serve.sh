...
echo "[TappsMCP] Launching MCP server: /home/wtthornton/.tapps-mcp/current/bin/tapps-platform serve --profile nlt-linear-issues" >&2
...
exec /home/wtthornton/.tapps-mcp/current/bin/tapps-platform serve --profile nlt-linear-issues "$@"
