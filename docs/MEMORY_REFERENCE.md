...
| `details.brain_version` below the floor (e.g. `3.27.x`) | Installed brain is older than the version pinned by tapps-mcp. | Upgrade tapps-brain — current floor is **3.28.0** per [ADR-0033](adr/0033-pin-tapps-brain-version-floor-at-3280.md). |
