...
| `tool_preset` | `Literal['full', 'core', 'planner', 'release', 'auditor'] | None` | `Field(default=None, description="Predefined tool set: 'full' = all 40 tools; 'core' = 6 bootstrap tools; 'planner' = epic/story/Linear (10); 'release' = changelog/release gate (10); 'auditor' = check_* suite (10). Used when enabled_tools is not set. Env: DOCS_MCP_TOOL_PRESET.")` |
