...
| `tool_preset` | `Literal['full', 'core'] | None` | `Field(default=None, description="Predefined tool set: 'full' = all tools, 'core' = session_start, project_scan, check_drift, generate_readme, check_completeness, check_links. Used when enabled_tools is not set. Env: DOCS_MCP_TOOL_PRESET.")` |
