...
>
> **Audience note:** these recommendations are for **consumer projects** that adopt TappsMCP. The tapps-mcp repo itself uses a commit-direct-to-master workflow (no PRs); see [`.claude/rules/repo-workflow.md`](../.claude/rules/repo-workflow.md).
