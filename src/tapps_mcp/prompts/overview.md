...
| # | Stage | Purpose | Tools |
|---|-------|---------|-------|
| 1 | **Discover** | Understand server capabilities and project context | `tapps_server_info`, `tapps_project_profile` |
...
| 5 | **Verify** | Final checklist to confirm no steps were skipped | `tapps_checklist` |
