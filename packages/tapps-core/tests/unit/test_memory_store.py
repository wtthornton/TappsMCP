...
from tapps_core.memory.models import MemoryEntry, MemoryScope, MemoryTier
from tapps_core.memory.store import MemoryStore, _MAX_ENTRIES
...
class TestMemoryStoreRAGSafety:
    ...
    def test_blocked_content_returns_error(self, store: MemoryStore) -> None:
        ...
        with patch(
            ...
            from tapps_core.knowledge.rag_safety import SafetyCheckResult
