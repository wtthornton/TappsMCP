...
_BLOCKLIST: frozenset[str] = frozenset({
    "the", "and", "for", "not", "with", "from", "this", "that", "when", "then",
    "else", "elif", "try", "except", "finally", "raise", "pass", "import", "as",
    "true", "false", "none", "self", "cls", "args", "kwargs", "mcs", "new",
    "get", "set", "put", "run", "main", "data", "info", "item", "items", "key",
    "keys", "val", "value", "values", "list", "dict", "obj", "old",
    "str", "int", "bool", "float", "type", "types", "error", "errors", "err",
    "helper", "helpers", "utils", "util", "base", "mixin", "meta", "abc", "impl",
    "factory", "mock", "patch", "test", "tests", "case", "setup", "teardown",
    "fixture", "config", "opts", "opt", "ctx", "req", "res", "resp", "http",
    "url", "uri", "api", "cli", "uid", "id", "idx", "num", "count", "size",
    "len", "min", "max", "sum", "any", "all", "map", "filter", "open", "read",
    "write", "path", "file", "name", "names", "text", "body", "head", "tail",
    "node", "root", "child", "parent", "left", "right", "next", "prev", "first",
    "last", "start", "end", "step", "init", "call", "wrap", "inner", "outer",
})
