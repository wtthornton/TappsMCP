...
_DISPATCH: dict[str, Callable[[MemoryStore, _Params], dict[str, Any]]] = {
    ...
    # NOTE: federate_* handlers were removed with ``tapps_brain.federation``
    # (deleted in tapps-brain v3, ADR-007); the actions remain valid names and
    # return the refused-envelope pointing at the direct brain tools.
