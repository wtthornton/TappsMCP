...
1. Call `{{docs_prefix}}docs_check_drift` to find docs that are out of sync with code
2. Call `{{docs_prefix}}docs_check_freshness` to identify stale documentation
3. Call `{{docs_prefix}}docs_check_completeness` for a documentation health score
4. Call `{{docs_prefix}}docs_check_links` to find broken internal links
5. Call `{{docs_prefix}}docs_check_diataxis` for content balance analysis
