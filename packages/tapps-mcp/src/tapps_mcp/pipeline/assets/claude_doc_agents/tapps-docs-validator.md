...
2. Call `{{docs_prefix}}docs_check_links` on changed files
3. Call `{{docs_prefix}}docs_check_freshness` to verify nothing is stale
4. Call `{{docs_prefix}}docs_check_drift` on the project
