"""GitHub Issue form and PR template generators.

Epic 19: Generate structured GitHub Issue form templates and PR templates
as part of ``tapps_init``. Makes repositories machine-parseable for AI
agents and establishes consistent contribution patterns.
...
MANAGED_GITHUB_ROOT_FILES: tuple[str, ...] = ("PULL_REQUEST_TEMPLATE.md",)
...
def generate_all_github_templates(project_root: Path) -> dict[str, Any]:
    """Generate all GitHub templates (issues, PR).
