...
CLAUDE_SKILLS["orchestration-prompt"] = _load_claude_skill("orchestration-prompt")
...
CLAUDE_SKILLS["continuous-learning-v2"] = _load_claude_skill("continuous-learning-v2")
