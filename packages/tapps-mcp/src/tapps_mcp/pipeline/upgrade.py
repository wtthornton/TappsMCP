...
from tapps_mcp.pipeline.upgrade_optional_integrations import refresh_optional_integrations
...
def upgrade_pipeline(
    ...
    *,
    ...
    refresh_optional_integrations(project_root, result, dry_run=dry_run, mcp_only=mcp_only)
