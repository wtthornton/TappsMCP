...
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_HOOKS_CONFIG_PS as LINEAR_CACHE_GATE_HOOKS_CONFIG_PS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_KEY_PS as LINEAR_CACHE_GATE_KEY_PS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_KEY_PY as LINEAR_CACHE_GATE_KEY_PY,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_POST_LIST_SCRIPT as LINEAR_CACHE_GATE_POST_LIST_SCRIPT,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_POST_SNAPSHOT_SCRIPT as LINEAR_CACHE_GATE_POST_SNAPSHOT_SCRIPT,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_POST_SNAPSHOT_SCRIPT_PS as LINEAR_CACHE_GATE_POST_SNAPSHOT_SCRIPT_PS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_PRE_LIST_SCRIPT as LINEAR_CACHE_GATE_PRE_LIST_SCRIPT,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_PRE_LIST_SCRIPT_PS as LINEAR_CACHE_GATE_PRE_LIST_SCRIPT_PS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_SCRIPTS as LINEAR_CACHE_GATE_SCRIPTS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    LINEAR_CACHE_GATE_SCRIPTS_PS as LINEAR_CACHE_GATE_SCRIPTS_PS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    SESSION_START_GATE_HOOKS_CONFIG as SESSION_START_GATE_HOOKS_CONFIG,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    SESSION_START_GATE_HOOKS_CONFIG_PS as SESSION_START_GATE_HOOKS_CONFIG_PS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    SESSION_START_GATE_POST_SCRIPT as SESSION_START_GATE_POST_SCRIPT,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    SESSION_START_GATE_POST_SCRIPT_PS as SESSION_START_GATE_POST_SCRIPT_PS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    SESSION_START_GATE_PRE_SCRIPT as SESSION_START_GATE_PRE_SCRIPT,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    SESSION_START_GATE_PRE_SCRIPT_PS as SESSION_START_GATE_PRE_SCRIPT_PS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    SESSION_START_GATE_SCRIPTS as SESSION_START_GATE_SCRIPTS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    SESSION_START_GATE_SCRIPTS_PS as SESSION_START_GATE_SCRIPTS_PS,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    render_cache_gate_scripts as render_cache_gate_scripts,
)
from tapps_mcp.pipeline.platform_hook_templates_linear_gate import (
    render_session_start_gate_scripts as render_session_start_gate_scripts,
)
...
exit 0
""",
    "tapps-after-edit.ps1": _cursor_after_edit_ps1_script(),
    "tapps-stop.ps1": """\
...
# key TappsMCP hadn't yet catalogued (e.g. a consumer's StopFailure).  Filtering
