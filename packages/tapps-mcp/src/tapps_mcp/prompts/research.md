...
3. For domain-specific decisions (security patterns, testing strategies, API design, etc.), use `tapps_lookup_docs` with a relevant topic to find best practices.
4. Record all findings - API signatures, patterns, recommendations.
