...
| # | Stage | Purpose | Tools |
|---|-------|---------|-------|
| 1 | **Discover** | Understand server capabilities, project context, and recall memory | `tapps_session_start` (hooks + `tapps-mcp memory` CLI) |
| 2 | **Research** | Look up library documentation | `tapps_lookup_docs` |
...
1. Call `tapps_session_start` to initialize session and discover available tools.
