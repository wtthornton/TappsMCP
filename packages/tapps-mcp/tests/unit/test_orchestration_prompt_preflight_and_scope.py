...
# TAP-7017: method §0c's full elaboration and the Guardrails "Scope" bullet
# moved out of SKILL.md's managed block into references/method-detail.md and
# references/guardrails-and-contracts.md respectively, each reachable from
# SKILL.md by an explicit pointer.
...
class TestWorkspaceScopeFence:
    ...
    def test_workspace_dir_list_is_the_scope_fence(self) -> None:
        body = _GUARDRAILS_AND_CONTRACTS
