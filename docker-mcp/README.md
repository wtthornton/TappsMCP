...
docker-mcp/
  ...
  profiles/
    ...
    tapps-standard-190.yaml # Pinned to 1.9.0
  examples/
...
| `tapps-standard-190` | tapps-mcp, docs-mcp, context7 @ 1.9.0 | Pinned to 1.9.0 |
...
| Server | Image (pinned 1.9.0) | Dockerfile |
|--------|----------------------|------------|
| tapps-mcp | `ghcr.io/wtthornton/tapps-mcp:1.9.0` | `Dockerfile` |
| docs-mcp | `ghcr.io/wtthornton/docs-mcp:1.9.0` | `packages/docs-mcp/Dockerfile` |
