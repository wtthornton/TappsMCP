...
7. After all writes, call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_linear_snapshot_invalidate(team, project)`.
...
5. After `save_issue` returns, call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_linear_snapshot_invalidate(team=<team>, project=<project>)` to evict stale cached snapshots for that slice.
...
6. After any write, call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_linear_snapshot_invalidate(team=<team>, project=<project>)` to refresh the cache on next read.
