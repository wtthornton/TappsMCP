...
allowed-tools: mcp__plugin_tapps-mcp_tapps-mcp__tapps_validate_changed mcp__plugin_tapps-mcp_tapps-mcp__tapps_checklist
context: fork
...
1. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_session_start` if not already called
...
6. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_validate_changed` with explicit `file_paths` to verify all files pass
...
8. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_checklist(task_type="review")` for final verification — clear
