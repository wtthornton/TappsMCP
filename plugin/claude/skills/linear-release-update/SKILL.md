...
allowed-tools: mcp__plugin_tapps-mcp_tapps-mcp__tapps_release_update mcp__nlt-release-ship__docs_generate_release_update mcp__nlt-release-ship__docs_validate_release_update mcp__nlt-release-ship__docs_release_gate mcp__plugin_linear_linear__save_document mcp__plugin_tapps-mcp_tapps-mcp__tapps_linear_snapshot_invalidate
...
1. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_release_update(version, prev_version, team, project)`.
...
4. After `save_document` succeeds, call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_linear_snapshot_invalidate`:
