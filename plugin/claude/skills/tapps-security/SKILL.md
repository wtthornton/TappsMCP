...
allowed-tools: >-
  mcp__plugin_tapps-mcp_tapps-mcp__tapps_security_scan
  mcp__plugin_tapps-mcp_tapps-mcp__tapps_dependency_scan
argument-hint: "[file-path]"
---

Run a comprehensive security audit using TappsMCP:

1. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_security_scan` on the target file to detect vulnerabilities
2. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_dependency_scan` to check for known CVEs in dependencies
