...
1. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_score_file` to get the full 7-category breakdown
2. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_security_scan` to check for security issues
3. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_dead_code` to detect unused code
4. Fix all issues found: lint violations, security findings, dead code
5. Call `mcp__plugin_tapps-mcp_tapps-mcp__tapps_quality_gate` to verify the file passes
