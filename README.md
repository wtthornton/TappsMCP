...
Pins `nlt-report-studio` via git tag `v0.1.3` in `pyproject.toml` (no sibling `ReportLab` checkout required). For engine development, temporarily switch to `path = "../ReportLab", editable = true`.
